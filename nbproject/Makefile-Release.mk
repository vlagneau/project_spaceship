...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/project_spaceship.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/project_spaceship.exe: ${OBJECTFILES}
...
${OBJECTDIR}/src/Spaceship.o: src/Spaceship.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Spaceship.o src/Spaceship.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/project_spaceship.exe
